...
def mostrar_registro_paciente():
  ...
  ttk.Label(ventana, text="Email:", style="TLabel").grid(row=3, column=0, pady=5)
...
def mostrar_actualizacion_paciente():
  ...
  def actualizar_paciente():
    ...
    ttk.Label(actualizacion_ventana, text="Email:", style="TLabel").grid(row=3, column=0)
    email_entry = ttk.Entry(actualizacion_ventana, style="TEntry")
    email_entry.insert(0, paciente_actual[4])  # Email actual
    email_entry.grid(row=3, column=1, pady=5)

    ttk.Label(actualizacion_ventana, text="Dirección:", style="TLabel").grid(row=4, column=0)
