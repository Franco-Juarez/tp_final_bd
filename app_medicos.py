...
def mostrar_registro_medico():
    ...
    ttk.Label(ventana, text="Teléfono:", style="TLabel").grid(row=2, column=0, pady=5)
    telefono_entry = ttk.Entry(ventana, style="TEntry")
    telefono_entry.grid(row=2, column=1, pady=5)

    ttk.Label(ventana, text="Especialidad:", style="TLabel").grid(row=3, column=0, pady=5)
    especialidad_entry = ttk.Entry(ventana, style="TEntry")
    especialidad_entry.grid(row=3, column=1, pady=5)
    ...
    def registrar_medico():
        ...
        medico_db.registrar_medico(nombre, apellido, telefono, especialidad)
...
def mostrar_actualizacion_medico():
    ...
    def actualizar_medico():
        ...
        ttk.Label(actualizacion_ventana, text="Teléfono:", style="TLabel").grid(row=2, column=0)
        telefono_entry = ttk.Entry(actualizacion_ventana, style="TEntry")
        telefono_entry.insert(0, medico_actual[3])  # Teléfono actual
        telefono_entry.grid(row=2, column=1, pady=5)

        ttk.Label(actualizacion_ventana, text="Especialidad:", style="TLabel").grid(row=3, column=0)
        especialidad_entry = ttk.Entry(actualizacion_ventana, style="TEntry")
        especialidad_entry.insert(0, medico_actual[4])  # Especialidad actual
        especialidad_entry.grid(row=3, column=1, pady=5)
        ...
        def guardar_cambios():
            ...
            medico_db.actualizar_medico(medico_id, nombre, apellido, telefono, especialidad)
...
def mostrar_medicos():
    ...
    for medico in medico_db.ver_medicos():
        listbox.insert(tk.END, f"{medico[0]} - {medico[1]} {medico[2]} - {medico[4]}")
